...
<p>Sarà poi necessario un software di API testing (nel nostro caso è stato utilizzato Postman) per eseguire le richieste GET o POST.<br>
Nella seguente tabella sono riassunte le possibili richieste.</p>
...
</table><p>Mentre per quanto riguarda il filtraggio, i parametri passabili sono i seguenti:</p>
...
</table><h2 id="create-files-and-folders">Create files and folders</h2>
